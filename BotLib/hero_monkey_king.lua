...
function X.ConsiderBoundlessStrike()
    ...
    then
        ...
        then
            ...
            and ((#nNeutralCreeps >= 3 and nLocationAoECount >= 3)
                or (#nNeutralCreeps >= 2 and nNeutralCreeps[1]:IsAncientCreep() and nLocationAoECount >= 2))
            then
                return BOT_ACTION_DESIRE_HIGH, nLocationAoETarget
            end
