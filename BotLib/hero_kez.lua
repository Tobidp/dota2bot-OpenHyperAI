...
function X.ConsiderEchoSlash()
    ...
    then
        ...
        then
            ...
            if nLocationAoECount >= 4 and bot:IsFacingLocation(nLocationAoETarget, 20) then
                return BOT_ACTION_DESIRE_HIGH
            end
        end
    end
    ...
    then
        ...
        then
            ...
            if (nLocationAoECount >= 2 or (nLocationAoECount >= 2 and nCreeps[1]:IsAncientCreep()))
            and bot:IsFacingLocation(nLocationAoETarget, 20)
            then
                return BOT_ACTION_DESIRE_HIGH
            end
        end
    ...
    then
        ...
        then
            ...
            if nLocationAoECount >= 5
            and bot:IsFacingLocation(nLocationAoETarget, 15)
            then
                return BOT_ACTION_DESIRE_HIGH
            end
        end
