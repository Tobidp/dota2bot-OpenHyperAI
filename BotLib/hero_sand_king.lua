...
function X.ConsiderQ()
	...
	then
		...
		return BOT_ACTION_DESIRE_HIGH, nTargetLocation, 'Q-Aoe:'..( nCanHurtEnemyAoECount )
	end
	...
	then
		...
		then
			...
			then
				...
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "Q-打钱:"..locationAoECount
			end
		end
	end
	...
	then
		...
		then
			...
			if locationAoEHurtCount >= 3
			then
				nTargetLocation = locationAoEHurtTarget
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "Q-推线"..locationAoEHurtCount
			end
		end
	end
...
function X.ConsiderW()
	...
	then
		return BOT_ACTION_DESIRE_HIGH, J.GetEscapeLoc(), 'W-躲避'
	end
