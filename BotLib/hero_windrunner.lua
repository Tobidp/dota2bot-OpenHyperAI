    ...
    then
        ...
        then
            ...
            and botMP > 0.33 then
                ...
                if nLocationAoECount >= 3 or nLocationAoECount >= 1 and tCreeps[1]:IsAncientCreep() then
                    return BOT_ACTION_DESIRE_HIGH, nLocationAoETarget
                end
            end
        end
...
function X.ConsiderGaleForce()
    ...
    then
        ...
        if #nInRangeEnemy >= 2
        and not J.IsEnemyChronosphereInLocation(nLocationAoETarget)
        and not J.IsEnemyBlackHoleInLocation(nLocationAoETarget)
        then
            return BOT_ACTION_DESIRE_HIGH, nLocationAoETarget
        end
    end
