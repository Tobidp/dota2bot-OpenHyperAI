...
function X.ConsiderLittleFriends()
    ...
    then
        local npcTarget = J.GetStrongestUnit(nCastRange, bot, true, false, nDuration)
        ...
        then
            local nTargetInRangeEnemy = J.GetNearbyHeroes(npcTarget, nRadius, true, BOT_MODE_NONE)
