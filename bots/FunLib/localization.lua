...
local Localization = {
    en = {
        welcome_msgs = {
            "Welcome to Open Hyper AI (OHA) - TobiDP - 14/05/26 - revision 0.2",
        ...
        fret_ally_scale_open = 'Now vote for ally bot bonus scale (range: 0.0 to 1.0). Default scale: ',
        fret_ally_vote_hint = 'Enter a number from 0.0 to %d. 1.0 = full ally bonus (same scale as enemy bots). 0.5 = half ally bonus. 0.0 = no ally bonus. Values above 1.0 are not allowed.',
